  ...
  return (
    <ThreadPrimitive.ScrollToBottom asChild>
      <TooltipIconButton
        ...
        variant="outline"
        className="aui-thread-scroll-to-bottom absolute -top-12 z-10 self-center size-9 rounded-full disabled:invisible dark:border-border dark:bg-background dark:hover:bg-accent"
      >
        <ArrowDownIcon />
      </TooltipIconButton>
